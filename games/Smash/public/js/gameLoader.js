...
import Slime from './classes/characters/slime.js';
...
function loadGame(game, characters) {
    ...
    switch (characters.p1) {
        ...
        case 'Alien':
            ...
            break;
        case 'Slime':
            player1 = new Slime({ x: game.player1.x, y: game.player1.y, spawnPoint: { x: game.player1.x, y: game.player1.y } });
            break;
    ...
    switch (characters.p2) {
        ...
        case 'Alien':
            ...
            break;
        case 'Slime':
            player2 = new Slime({ x: game.player2.x, y: game.player2.y, spawnPoint: { x: game.player2.x, y: game.player2.y }, isShiny: true });
            break;
